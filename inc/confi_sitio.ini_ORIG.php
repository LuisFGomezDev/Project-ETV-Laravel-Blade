<?PHP
    ...
    //--------------------------------------------------------------------------	
	$carpeta_web="Aplicacion_San_Vicente_SVF";//Carpeta donde esta alojado baul de tesoros
	...
	$usuarios_sesion="auten_San_Vicente_SVF";
	$GLOBALS['db']=null;

	//Nombre del sitio Web
	$nombre_sitio_web="<-- Captura Novedades -->";
?>