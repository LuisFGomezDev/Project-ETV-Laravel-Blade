// esta rutina se ejecuta cuando jquery esta listo para trabajar
		$(function() 
		{
			...
			$("#txtProducto").autocomplete({
				source: "./controlador/buscarC.php", 				/* este es el formulario que realiza la busqueda */
		...
		function productoSeleccionado(event, ui)
		{
			...
			// (intenta comentando este codigo para ver a que me refiero)
			$("#txtProducto").val(producto.descripcion);
                        $("#lblSectorBarrio").text(producto.descripcion);
                        $("#idCalle").load("./controlador/varios.php?opcion=listaCalles&idBarrio="+producto.idBarrio);
			event.preventDefault();
		}