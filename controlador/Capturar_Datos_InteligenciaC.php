...
if(($_SESSION['usuario_id'])!=-1)
{
    ...
    //***** Zona de validaciones de los campos   
     ...
     $MedioVerific_IE_R1_i1="Informes";
     $Supuesto_IE_R1_i1="Articulacion de los actores de la vigilancia de las ETV";

     $MedioVerific_IE_R1_i2="Informes";
     $Supuesto_IE_R1_i2="Articulacion de los actores de la vigilancia de las ETV";
     
     $MedioVerific_IE_R1_i3="Informes";
     $Supuesto_IE_R1_i3="Articulacion de los actores de la vigilancia de las ETV";
     
     $MedioVerific_IE_R1_i4="Informes";
     $Supuesto_IE_R1_i4="Articulacion de los actores de la vigilancia de las ETV";

     $MedioVerific_IE_R1_i5="Informes";
     $Supuesto_IE_R1_i5="Articulacion de los actores de la vigilancia de las ETV";
     
     $MedioVerific_IE_R1_i6="Informes";
     $Supuesto_IE_R1_i6="Articulacion de los actores de la vigilancia de las ETV";
     ...
     $ActividadSupuesto="Articulación de los actores de la vigilancia de las ETV -Existencia de lineamientos nacionales -Capacidad de liderazgo de los grupos de vigilancia en salud publica";
     ...
     //Asigno el valor del resultado elegido para trabajar
        ...
        {
            $ResultadoElegido="IE-R1";
        }
        else

        if($ResultadoElegido==2)
        {
            $ResultadoElegido="IE-R2";
        }
     }
     else
        {             
     ...
     //Asigno el codigo del Indicador seleccionado para trabajar
        ...
        {
            $IndicadorElegido="IE-R1-I1";
            
            $MedioVerific=$MedioVerific_IE_R1_i1;
            $Supuesto=$Supuesto_IE_R1_i1;
        }
        else

        if(($IndicadorElegido==2))
        {
            $IndicadorElegido="IE-R1-I2";
            
            $MedioVerific=$MedioVerific_IE_R1_i2;
            $Supuesto=$Supuesto_IE_R1_i2;
        }
        else

        if(($IndicadorElegido==3))
        {
            $IndicadorElegido="IE-R1-I3";
            
            $MedioVerific=$MedioVerific_IE_R1_i3;
            $Supuesto=$Supuesto_IE_R1_i3;
        }
        else

        if(($IndicadorElegido==4))
        {
            $IndicadorElegido="IE-R2-I1";
            
            $MedioVerific=$MedioVerific_IE_R2_i1;
            $Supuesto=$Supuesto_IE_R2_i1;
        }
        else

        if(($IndicadorElegido==5))
        {
            $IndicadorElegido="IE-R2-I2";
            
            $MedioVerific=$MedioVerific_IE_R2_i2;
            $Supuesto=$Supuesto_IE_R2_i2;
        }
        
        if(($IndicadorElegido==6))
        {
            $IndicadorElegido="IE-R2-I3";
            
            $MedioVerific=$MedioVerific_IE_R2_i3;
            $Supuesto=$Supuesto_IE_R2_i3;
        }
     ...
     //Asigno el codigo de la actividad seleccionada para trabajar
        ...
        //La actividad elegida fue: IE-R1-I1
        if(($Actividad_Elegida==1)&&($IndicadorElegido="IE-R1-I1"))
        {
            $Actividad_Elegida="IE-R1-I1-A1";
            
            $ActividadIndicador1="IE-R1-I1-A1-i1";  
            $ActividadIndicador2="IE-R1-I1-A1-i2";  
            $ActividadIndicador3="NO APLICA";  
            $ActividadIndicador4="NO APLICA";  

            $Medio_ActividadIndicador1="Documento";  
            $Medio_ActividadIndicador2="Informe de Asistencia Tecnica";  
        ...
        else//La actividad elegida fue: IE-R1-I1

        if(($Actividad_Elegida==2)&&($IndicadorElegido="IE-R1-I1"))        
        {
            $Actividad_Elegida="IE-R1-I1-A2";
            
            $ActividadIndicador1="IE-R1-I1-A2-i1";  
            $ActividadIndicador2="IE-R1-I1-A2-i2";  
            $ActividadIndicador3="NO APLICA";  
            $ActividadIndicador4="NO APLICA";  
        ...
        if(($Actividad_Elegida==3)&&($IndicadorElegido="IE-R1-I1"))        
        {
            $Actividad_Elegida="IE-R1-I1-A3";
            
            $ActividadIndicador1="IE-R1-I1-A3-i1";  
            $ActividadIndicador2="NO APLICA";  
            $ActividadIndicador3="NO APLICA";  
            $ActividadIndicador4="NO APLICA";  

            $Medio_ActividadIndicador1="Informes de seguimiento";  
        ...
        if(($Actividad_Elegida==4)&&($IndicadorElegido="IE-R1-I2"))        
        {
            $Actividad_Elegida="IE-R1-I1-A1";
            
            $ActividadIndicador1="IE-R1-I1-A1-i1";  
            $ActividadIndicador2="IE-R1-I1-A1-i2";  
            $ActividadIndicador3="IE-R1-I1-A1-i3";  
            $ActividadIndicador4="IE-R1-I1-A1-i4";  

            $Medio_ActividadIndicador1="Actas de reunion - Cronogramas - Plan de Accion";  
            $Medio_ActividadIndicador2="Actas de reunion - Cronogramas - Plan de Accion";  
            $Medio_ActividadIndicador3="Actas de reunion - Cronogramas - Plan de Accion";  
            $Medio_ActividadIndicador4="Actas de reunion - Cronogramas - Plan de Accion"; 
        ...
        if(($Actividad_Elegida==5)&&($IndicadorElegido="IE-R1-I2"))        
        {
            $Actividad_Elegida="IE-R1-I2-A2";
            
            $ActividadIndicador1="IE-R1-I2-A2-i1";  
            $ActividadIndicador2="IE-R1-I2-A2-i2";  
            $ActividadIndicador3="IE-R1-I2-A2-i3";  
            $ActividadIndicador4="NO APLICA";  

            $Medio_ActividadIndicador1="Conjunto de protocolos, procedimientos e instructivos";  
        ...
        if(($Actividad_Elegida==6)&&($IndicadorElegido="IE-R1-I2"))        
        {
            $Actividad_Elegida="IE-R1-I2-A3";
            
            $ActividadIndicador1="IE-R1-I2-A3-i1";  
            $ActividadIndicador2="NO APLICA";  
            $ActividadIndicador3="NO APLICA";  
            $ActividadIndicador4="NO APLICA";  

            $Medio_ActividadIndicador1="Mapa de riesgo departamental y Municipales";  
            $Medio_ActividadIndicador2="NO APLICA";  
            $Medio_ActividadIndicador3="NO APLICA";  
            $Medio_ActividadIndicador4="NO APLICA"; 
        ...
        if(($Actividad_Elegida==7)&&($IndicadorElegido="IE-R1-I2"))        
        {
            $Actividad_Elegida="IE-R1-I2-A4";
            
            $ActividadIndicador1="IE-R1-I2-A4-i1";  
            $ActividadIndicador2="NO APLICA";  
            $ActividadIndicador3="NO APLICA";  
            $ActividadIndicador4="NO APLICA";  

            $Medio_ActividadIndicador1="Boletines";  
            $Medio_ActividadIndicador2="NO APLICA";  
            $Medio_ActividadIndicador3="NO APLICA";  
            $Medio_ActividadIndicador4="NO APLICA"; 
        ...
        if(($Actividad_Elegida==8)&&($IndicadorElegido="IE-R1-I2"))        
        {
            $Actividad_Elegida="IE-R1-I2-A5";
            
            $ActividadIndicador1="IE-R1-I2-A5-i1";  
            $ActividadIndicador2="NO APLICA";  
            $ActividadIndicador3="NO APLICA";  
            $ActividadIndicador4="NO APLICA";  

            $Medio_ActividadIndicador1="Alertas Epidemiologicas";  
            $Medio_ActividadIndicador2="NO APLICA";  
            $Medio_ActividadIndicador3="NO APLICA";  
            $Medio_ActividadIndicador4="NO APLICA"; 
        ...
        if(($Actividad_Elegida==9)&&($IndicadorElegido="IE-R1-I3"))        
        {
            $Actividad_Elegida="IE-R1-I3-A1";
            
            $ActividadIndicador1="IE-R1-I3-A1-i1";  
            $ActividadIndicador2="NO APLICA";  
            $ActividadIndicador3="NO APLICA";  
            $ActividadIndicador4="NO APLICA";  

            $Medio_ActividadIndicador1="Informes de Vigilancia";  
            $Medio_ActividadIndicador2="NO APLICA";  
            $Medio_ActividadIndicador3="NO APLICA";  
            $Medio_ActividadIndicador4="NO APLICA"; 
        ...
        if(($Actividad_Elegida==10)&&($IndicadorElegido="IE-R1-I3"))        
        {
            $Actividad_Elegida="IE-R1-I3-A2";
            
            $ActividadIndicador1="IE-R1-I3-A2-i1";  
            $ActividadIndicador2="IE-R1-I3-A2-i2";  
            $ActividadIndicador3="NO APLICA";  
            $ActividadIndicador4="NO APLICA";  

            $Medio_ActividadIndicador1="Informes de Vigilancia";  
            $Medio_ActividadIndicador2="Informes de Vigilancia";  
            $Medio_ActividadIndicador3="NO APLICA";  
            $Medio_ActividadIndicador4="NO APLICA"; 
            
            $Activa_ConfirmaCargue = 10;
        }

        
        
        //EVENTOS PARA LAS ACTIVIDADES DE IE-R2
        else

        if(($Actividad_Elegida==11)&&($IndicadorElegido="IE-R2-I1"))        
        {
            $Actividad_Elegida="IE-R2-I2-A1";
            
            $ActividadIndicador1="IE-R2-I2-A1-i1";  
            $ActividadIndicador2="IE-R2-I2-A1-i2";  
            $ActividadIndicador3="NO APLICA";  
            $ActividadIndicador4="NO APLICA";  

            $Medio_ActividadIndicador1="Informes";  
            $Medio_ActividadIndicador2="Informes";  
            $Medio_ActividadIndicador3="NO APLICA";  
            $Medio_ActividadIndicador4="NO APLICA"; 
            
            $Activa_ConfirmaCargue = 11;
        }
        
        else

        if(($Actividad_Elegida==12)&&($IndicadorElegido="IE-R2-I2"))        
        {
            $Actividad_Elegida="IE-R2-I2-A1";
            ...
            $Activa_ConfirmaCargue = 12;
        }
        
        else

        if(($Actividad_Elegida==13)&&($IndicadorElegido="IE-R2-I2"))        
        {
            $Actividad_Elegida="IE-R2-I2-A1";
            ...
            $Activa_ConfirmaCargue = 13;
        }
        
        else

        if(($Actividad_Elegida==14)&&($IndicadorElegido="IE-R2-I3"))        
        {
            $Actividad_Elegida="IE-R2-I3-A1";
            
            $ActividadIndicador1="IE-R2-I3-A1-i1";  
            $ActividadIndicador2="IE-R2-I3-A1-i2";  
            $ActividadIndicador3="IE-R2-I3-A1-i3";  
            $ActividadIndicador4="NO APLICA";  

            $Medio_ActividadIndicador1="Documento";  
            $Medio_ActividadIndicador2="Informe";  
            $Medio_ActividadIndicador3="Informe";  
            $Medio_ActividadIndicador4="NO APLICA"; 
            
            $Activa_ConfirmaCargue = 14;
        }
