...
if(($_SESSION['usuario_id'])!=-1)
{
    ...
    //***** Zona de validaciones de los campos   
     ...
     $Supuesto_GC_R1_I2="Redes de generación de conocimiento aplicado conformadas -Disponibilidad de recursos financieros";
     
     $MedioVerific_GC_R2_I1="Informes asistencia tecnica -Planes de accion";
     $Supuesto_GC_R2_I1="Voluntad política de los actores -Disponibilidad de recursos financieros -Capacidad de gestión del líder del programa";
     ...
     //Asigno el codigo de la actividad seleccionada para trabajar
        ...
        if(($Actividad_Elegida==7)&&($IndicadorElegido="GC-R2-I1"))        
        {
            ...
            $Medio_ActividadIndicador1="Voluntad política de los actores";  
            $Medio_ActividadIndicador2="Disponibilidad de recursos financieros";  
            $Medio_ActividadIndicador3="Capacidad de gestión del líder del programa";  
     ...
     //************************************************************   
        if(!empty($_POST['ConfirmaI5'])&&($_POST['ConfirmaI5'])=="S")
        {
            ...
            $TamañoFile5 = ($_FILES['archivo1']['size'][4]);
            ...
            $Resultado5=$gestion_cargue_archivos5->ProcesarCargue_Files($TipoFile5,$TamañoFile5,$NombreFile5,$Tmp_NombreFile5,$Nombre_Municipio);
            ...
            if($Resultado5==4)//Retorna 4 cuando es tamaño del archivo NO es el permitido
            {
                            $error[]="Error...El Tamaño del archivo para i5 supera el espacio permitido de 2 Megas";
            }
        }
     //************************************************************   
